...
<pre><code>
  ...
  # This routes to the admin portal for the calendar, where :id is the current date (e.g. 2010-01-14)
  map.connect  '/admin/calendars/:id', :controller => 'calendars', :action => 'index'
  
  # This shows all events for the chosen day
  map.connect  '/daily_event/:id', :controller => 'calendars', :action => 'daily_list'
  
  # This shows a list of all events for the current month, where :id is the current date (e.g. 2010-01-14)
  map.connect '/calendar/:id', :controller => 'calendars', :action => 'calendar_list'
  
  # This shows the details of an individual calendar event
  map.connect '/calendars/:id', :controller => 'calendars', :action => 'show'
  
  # This shows a list of calendar events filtered by program
